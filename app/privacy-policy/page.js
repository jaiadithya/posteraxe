    ...
    <>
      <div className="mb-20  px-6 md:px-30 lg:px-[200px] space-y-10">
        <div className="justify-center flex">
          <h1 className="text-5xl font-black pb-10"> PRIVACY POLICY </h1>
        </div>
        ...
        <h3 className="text-lg font-normal">
          ...
          the posteraxe.in website ("Website" or "Service") and any of its
          related products and services (collectively, "Services") is collected,
          ...
          and agree to be bound by the terms of this Agreement. This Policy does
        ...
        <div className="space-y-6 ">
          ...
          <h3 className="text-lg font-normal">
            ...
            knowingly provide to us when you make a purchase, or fill any online
            forms on the Website. When required, this information may include
            the following:
          </h3>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Billing and payments</h2>
          ...
          <h3 className="text-lg font-normal">
            ...
            of your Personal Information is governed by their respective privacy
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Disclosure of information</h2>

          <h3 className="text-lg font-normal">
            Depending on the requested Services or as necessary to complete any
            transaction or provide any service you have requested, we may
            contract with other companies and share your information with your
            consent with our trusted third parties that work with us, any other
            affiliates and subsidiaries we rely upon to assist in the operation
            of the Website and Services available to you. We do not share
            Personal Information with unaffiliated third parties. These service
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Retention of information</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Transfer of information</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">The rights of users</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">How to exercise these rights</h2>
          ...
          <h3 className="text-lg font-normal">
            ...
            such requests. Your request must provide sufficient information that
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Privacy of children</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Cookies </h2>
          ...
          <h3 className="text-lg font-normal">
            ...
            browser setting to decline cookies if you prefer. To learn more
            about cookies and how to manage them, visit internetcookies.org
          </h3>
        </div>

        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Do not track signals</h2>
          ...
          <h3 className="text-lg font-normal">
            ...
            some third party sites may keep track of your browsing activities
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Advertisements</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Email marketing</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Links to other resources</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Information security</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Data breach</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Changes and amendments</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Acceptance of this policy</h2>
        ...
        <div className="space-y-6 ">
          <h2 className="text-3xl font-normal">Contacting us</h2>
